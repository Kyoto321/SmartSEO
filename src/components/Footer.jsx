    ...
    <div className='bg-gray-950'>
      <div className='md:mx-20'>
          ...
          <div className="mt-20">
              ...
              <ul className='flex flex-col text-lg  font-medium gap-2 text-gray-600'>
                  <li>Home</li>
                  <li>Services</li>
                  <li>About us</li>
                  <li>Our Team</li>
          ...
          <div className="mt-20">
              ...
              <ul className='flex text-lg font-medium flex-col gap-2 text-gray-600'>
                  <li>Facebook</li>
                  <li>Twitter</li>
                  <li>Dribble</li>
                  <li>Instagram</li>
          ...
          <div>
              <hr />
              <p className='py-5 text-gray-600 text-sm'>AxiomThemes © 2025. All Rights Reserved.</p>
          </div>
      </div>
    </div>
  )
